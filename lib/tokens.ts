...
export function tokensToTailwindConfig() {
  return {
    colors: {
      primary: Object.entries(tokens.colors.primary).reduce((acc, [key, value]) => {
        acc[key] = value;
        return acc;
      }, {} as Record<string, string>),
      secondary: Object.entries(tokens.colors.secondary).reduce((acc, [key, value]) => {
        acc[key] = value;
        return acc;
      }, {} as Record<string, string>),
      neutral: Object.entries(tokens.colors.neutral).reduce((acc, [key, value]) => {
        acc[key] = value;
        return acc;
      }, {} as Record<string, string>),
      success: Object.entries(tokens.colors.success).reduce((acc, [key, value]) => {
        acc[key] = value;
        return acc;
      }, {} as Record<string, string>),
      warning: Object.entries(tokens.colors.warning).reduce((acc, [key, value]) => {
        acc[key] = value;
        return acc;
      }, {} as Record<string, string>),
      error: Object.entries(tokens.colors.error).reduce((acc, [key, value]) => {
        acc[key] = value;
        return acc;
      }, {} as Record<string, string>),
